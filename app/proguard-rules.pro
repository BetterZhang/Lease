...
#-keep class com.jme.trade.domain.** {*;}
#-dontwarn com.jme.trade.domain.**
#-keep class com.jme.openaccount.domain.** {*;}
#-dontwarn com.jme.openaccount.domain.**
...
# Domain
#app
-keep class com.anshi.lease.domain.** {*;}
-dontwarn com.anshi.lease.domain.**
