...
public class BigDecimalUtil {
    ...
    public static String decimalFormatMoneyUnit(String money) {
        boolean flag;
        ...
        String moneyStr = format.format(new BigDecimal(value));

        String valueStr;

        if (valueCompare(new BigDecimal(value), new BigDecimal(0)) == 0)
            valueStr = "¥ 0.00";
         else
            valueStr = flag ? "- ¥ " + moneyStr : "+ ¥ " + moneyStr;
