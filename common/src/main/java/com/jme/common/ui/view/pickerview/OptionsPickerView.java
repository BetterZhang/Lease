...
public class OptionsPickerView<T> extends BasePickerView {
    ...
    private RelativeLayout btnSubmit, btnCancel; //确定、取消按钮
    ...
    public OptionsPickerView(Builder builder) {
        ...
        this.confirmListener = builder.confrimListener;
    ...
    public static class Builder {
        ...
        public Builder setConfirmListener(View.OnClickListener confirmListener) {
            this.confrimListener = confirmListener;
    ...
    private void initView(Context context) {
        ...
        if (customListener == null) {
            ...
            //确定和取消按钮
            btnSubmit = (RelativeLayout) findViewById(R.id.layout_confirm);
