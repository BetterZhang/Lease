...
public class ToolbarHelper {
    ...
    public void initToolbar(String title, @ColorInt int resId, @ColorInt int layoutColorId) {
        initToolbar(createTitleView());
        setTitle(title, resId, layoutColorId);
    }
    ...
    public void setTitle(String title, @ColorInt int resId, @ColorInt int layoutColorId) {
        if (bUserViewIsTitle) {
            TextView tv_title = (TextView) mUserView.findViewById(R.id.toolbar_title);
            tv_title.setTextColor(resId);
            tv_title.setText(title);
    ...
    public void setBackNavigation(boolean hasBack, @DrawableRes int drawableResId, View.OnClickListener listener) {
        if (hasBack) {
            mToolbar.setNavigationIcon(drawableResId);
